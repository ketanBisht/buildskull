...
export default function TrustSection() {
  return (
    <section className="py-20 bg-white border-y border-black/[0.04] overflow-hidden">
      ...
      <div className="relative flex overflow-hidden">
        ...
        >
          {[...clients, ...clients].map((client, i) => (
            <div
              key={i}
              className="text-2xl md:text-4xl font-black text-black/10 hover:text-black/30 transition-colors duration-500 cursor-default"
            >
              {client}
            </div>
          ))}
